...
class GeminiProcessor:
    ...
    def process_papers(self, papers: List[Dict]) -> List[Dict]:
        ...
        logger.info(f"Selected {len(selected_ids)}/{len(papers)} papers for AI")
    ...
    def _extract_tags(self, summary: str, paper: Dict) -> List[str]:
        ...
        method_map = {
            "machine_learning":  ["machine learning","neural network","deep learning","transformer","llm","gpt","reinforcement learning"],
            "empirical":         ["regression","panel data","fixed effects","instrumental variable"],
            ...
            "portfolio_methods": ["portfolio optimization","sharpe","alpha","factor","risk parity"],
